...
class Product {
  ...
  String? title;
  String? description;
  String? category;           // ← was Category enum
  double? price;
  ...
  String? availabilityStatus; // ← was AvailabilityStatus enum
  List<Review>? reviews;
  String? returnPolicy;       // ← was ReturnPolicy enum
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    category: json["category"],                    // ✅ no enum, no crash
    ...
    availabilityStatus: json["availabilityStatus"],  // ✅ no enum, no crash
    reviews: json["reviews"] == null
        ? []
        : List<Review>.from(json["reviews"].map((x) => Review.fromJson(x))),
    returnPolicy: json["returnPolicy"],              // ✅ no enum, no crash
...
// Keep Dimensions, Meta, Review, EnumValues unchanged
